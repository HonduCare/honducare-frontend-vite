          ...
          <div className="sidebar-inner slimscroll">
            ...
            >
              <ul>
                ...
                {usuarioLogged.id_rol == 3 ? (
                  <li className="submenu">
                    ...
                    <ul
                      style={{
                        display:
                          sidebar === "Administración" ? "block" : "none",
                      }}
                    ...
                    >
                      <li>
                        <Link
                          className={
                            props?.activeClassName === "usuario-list"
                              ? "active"
                              : ""
                          }
                          to="/Usuariolista"
                      ...
                      <li>
                        <Link
                          className={
                            props?.activeClassName === "Bitacora"
                              ? "active"
                              : ""
                          }
                          to="/Bitacora"
                      ...
                      <li>
                        <Link
                          className={
                            props?.activeClassName === "Permisos-roles"
                              ? "active"
                              : ""
                          }
                          to="/permisos-roles"
                  ...
                  <li className="submenu">
                    ...
                    <ul style={{ display: "none" }} className="menu-items4">
                      ...
                      <li>
                        <Link
                          className={
                            props?.activeClassName === "calendar"
                              ? "active"
                              : ""
                          }
                          to="/Calendario"
                ...
                {[1, 2, 3, 4].includes(usuarioLogged.id_rol) && (
                  <li className="submenu">
                    <Link
                      to="#"
                      id="menu-item5"
                    ...
                    <ul className="menu-items5">
                      {[1, 3, 4].includes(usuarioLogged.id_rol) && (
                        <li>
                          <Link
                            className={
                      ...
                      <li>
                        <Link
                          className={
                            props?.activeClassName === "preclinica-list"
                              ? "active"
                              : ""
                          }
                          to="/PreclinicaLista"
                      ...
                      <li>
                        <Link
                          className={
                            props?.activeClassName === "consulta-expediente"
                              ? "active"
                              : ""
                          }
                          to="/consulta-expediente"
                        >
                          Consultar Expediente Paciente
                        </Link>
                      </li>
                      ...
                      {usuarioLogged.id_rol !== 1 && (
                        <li>
                          <Link
                            className={
                              props?.activeClassName === "consulta-itinerario"
                                ? "active"
                                : ""
                            }
                            to="/consulta-itinerario"
                          >
                            Consultar Itinerario Doctor
                          </Link>
                        </li>
                      )}
                    </ul>
                  ...
                  <li className="submenu">
                    ...
                    <ul style={{ display: "none" }} className="menu-items6">
                      <li>
                        <Link
                          className={
                            props?.activeClassName === "lista-antecedentes"
                              ? "active"
                              : ""
                          }
                          to="/lista-antecedentes"
                        >
                          Antecedentes
                        </Link>
                      </li>
                      ...
                      <li>
                        <Link
                          className={
                            props?.activeClassName === "lista-estadocivil"
                              ? "active"
                              : ""
                          }
                          to="/lista-estadocivil"
                        >
                          Estado Civil
                        </Link>
                      </li>
                      ...
                      <li>
                        <Link
                          className={
                            props?.activeClassName === "lista-hg"
                              ? "active"
                              : ""
                          }
                          to="/lista-hg"
                      ...
                      <li>
                        <Link
                          className={
                            props?.activeClassName === "lista-ht"
                              ? "active"
                              : ""
                          }
                          to="/lista-ht"
                      ...
                      <li>
                        <Link
                          className={
                            props?.activeClassName === "lista-ocupaciones"
                              ? "active"
                              : ""
                          }
                          to="/lista-ocupaciones"
                        >
                          Ocupaciones
                        </Link>
                      </li>
                      <li>
                        <Link
                          className={
                            props?.activeClassName === "lista-patologias"
                              ? "active"
                              : ""
                          }
                          to="/lista-patologias"
                      ...
                      <li>
                        <Link
                          className={
                            props?.activeClassName === "lista-sexo"
                              ? "active"
                              : ""
                          }
                          to="/lista-sexo"
                        ...
                        <Link
                          className={
                            props?.activeClassName === "especialidades"
                              ? "active"
                              : ""
                          }
                          to="/especialidades"
