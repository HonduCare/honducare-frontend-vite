...
import {  imagesend, pdficon, pdficon3, pdficon4, refreshicon, searchnormal, plusicon } from '../imagepath';
        ...
        <div className="text-end">
          <div className="dropdown dropdown-action">
            ...
            <div className="dropdown-menu dropdown-menu-end">
              ...
              {usuarioLogged?.rol?.permisos.some((permiso) => permiso.nombre === "eliminar") && (
                <button
