...
const ConsultaExpediente = () => {
  ...
  async function obtenerExpedientePaciente() {
    ...
    }/obtener/expediente?identidad=${identidad}`;
          ...
          <div className="content">
            ...
            <div className="card">
              <div className="card-body">
                {error ? <p className="text-red p-2">{error}</p> : null}
                <div className="row">
                  ...
                  <>
                    ...
                    {expediente.paciente.tbl_sexo && (
                      <p>
                        Sexo:{" "}
                        <span className="fw-bold">
                          {expediente.paciente.tbl_sexo.descripcion}
                        </span>
                      </p>
                    )}
                    <p>
                      Nacionalidad:{" "}
                      <span className="fw-bold">
                        {expediente.paciente.nacionalidad}
                      </span>
                    </p>
